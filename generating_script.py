...
IaF_GrC_doc = nml.import_lems("lemsDefinitions/IaF_GrC.nml")
...
IaF_GrC = IaF_GrC_doc.IaF_GrC # note that here IaF_GrC_doc.IaF_GrC is
...
net.append(nml.SynapticConnection(from="GrCPop[0]",
